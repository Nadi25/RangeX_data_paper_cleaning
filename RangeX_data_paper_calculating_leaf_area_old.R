...
# Questions ---------------------------------------------------------------
# 1. Can I leave script as it is with having leaf scans in 4 folders
# and calculate leaf area  --> then delete duplicates
# and upload one folder with all scans (600) on OSF
#
# did leaf area calculations again without duplicates
