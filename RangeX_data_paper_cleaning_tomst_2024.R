...
# save clean data ---------------------------------------------------------
write.csv(rx_tomst_24_clean, "Data/Data_tomst_loggers/CleanEnvTMS4/RangeX_clean_EnvTMS4_2024_NOR.csv", row.names = FALSE)

tms24 <- read_csv("Data/Data_tomst_loggers/CleanEnvTMS4/RangeX_clean_EnvTMS4_2024_NOR.csv")
